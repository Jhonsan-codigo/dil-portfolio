...
public class PortfolioRepository {
    ...
    private synchronized void cargar() {
        try {
            ...
            if (dataFile.exists()) {
                ...
                // Verificar si faltan semanas 8 y 9, agregarlas automáticamente
    ...
    private void cargarInicial() {
        ...
        agregarSemanaSinGuardar("Estructuras condicionales", "Uso de if, else, switch y decisiones en programación.", "Programa con validaciones.", "Completado", 90);
    ...
    private void agregarSemanasFaltantes() {
        int totalSemanas = data.getSemanas().size();
        if (totalSemanas < 8) {
            agregarSemanaSinGuardar("Lógica de Negocio - Compras y Planillas", "Cálculo de compras por docenas con descuentos y planilla de empleados con bonificaciones y retenciones.", "Práctica de lógica de negocio.", "Completado", 100);
        }
        if (totalSemanas < 9) {
